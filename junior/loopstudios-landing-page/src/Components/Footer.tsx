function Footer() {
  return (
    <footer
      className="bg-black w-full text-white flex flex-col gap-10 items-center text-center p-10 
      lg:px-30 md:flex-row md:justify-between md:text-left"
    >
      <div className="flex flex-col gap-10 items-center md:items-start md:justify-between md:gap-5">
        <img src="/images/logo.svg" alt="logo" />

        <nav>
          <ul
            className="flex flex-col item-center gap-4 md:flex-row md:gap-10
      ...
      <div className="flex flex-col items-center gap-4 md:items-end md:justify-between md:gap-5">
        <div
          className="flex items-center gap-4 [&>div]:w-10 [&_svg]:w-full [&_path]:fill-white
          [&>div]:cursor-pointer [&>div:after]:content-[''] [&>div:after]:h-[2px] [&>div:after]:m-auto 
          [&>div:after]:bg-white [&>div:after]:block [&>div:after]:max-w-0 [&>div:hover:after]:max-w-[60%] 
          [&>div:after]:mt-2 [&>div:after]:transition-all"
        >
          <div>
