function Info() {
  return (
    <div className="text-center w-full border flex flex-col items-center gap-20 md:flex-row md:relative md:text-left">
      <picture>
        <source
      ...
      <div
        className="flex flex-col items-center gap-10 md:absolute md:bottom-0 
      ...
      >
        ...
        <p className="w-[80%] text-[2rem] text-black/50 md:text-[1rem]">
