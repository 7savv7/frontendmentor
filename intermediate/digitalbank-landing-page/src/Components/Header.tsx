...
function Header() {
  ...
  return (
    <header className="relative z-10 bg-white flex justify-center">
      <div className="flex justify-between items-center p-5 w-full md:p-0 md:px-5 lg:px-35 xl:px-50">
        <img className="md:my-5" src="/images/logo-dark.svg" alt="logo-dark" />

        <nav
          className={`absolute z-10 top-full left-0 w-full p-5 ${open ? "flex" : "hidden"} items-center justify-center 
          md:flex md:static md:w-fit md:p-0 md:h-full`}
        >
          <ul
            className="flex flex-col items-center bg-white gap-2 text-blue950 w-full p-5 rounded-md shadow-2xl 
